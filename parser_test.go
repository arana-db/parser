...
'`},
		...
		{"ADMIN OPTIMIZE TABLE", false, ""},
		{"ADMIN OPTIMIZE TABLE t", true, "ADMIN OPTIMIZE TABLE `t`"},
		{"ADMIN OPTIMIZE TABLE t1,t2", true, "ADMIN OPTIMIZE TABLE `t1`, `t2`"},
		{"ADMIN OPTIMIZE NO_WRITE_TO_BINLOG TABLE t1,t2", true, "ADMIN OPTIMIZE NO_WRITE_TO_BINLOG TABLE `t1`, `t2`"},
		{"ADMIN OPTIMIZE LOCAL TABLE t1,t2", true, "ADMIN OPTIMIZE NO_WRITE_TO_BINLOG TABLE `t1`, `t2`"},
